...
<Alert className="my-6">
  ...
  <AlertDescription>
    You'll need a code editor (we recommend VS Code) and a modern web browser (Chrome, Firefox, or Edge).
  </AlertDescription>
</Alert>
...
<Card className="my-6 border-green-200 bg-green-50 dark:bg-green-950/20 dark:border-green-800">
  ...
  <CardContent className="text-green-800 dark:text-green-200">
    <p>
      Your React app should now be running at <code className="font-mono">http://localhost:5173</code>. 
      Open it in your browser to see your first React application!
    </p>
  </CardContent>
</Card>
...
<Card className="my-6">
  <CardContent className="pt-6">
    <div className="flex justify-between items-center">
      ...
      <span className="font-semibold">JSX Syntax</span>
    </div>
  </CardContent>
</Card>
