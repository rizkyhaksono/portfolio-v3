...
<NextLesson title="Database Integration with MongoDB/PostgreSQL" description="Now that you understand routing and middleware, let's connect to a database and build real CRUD operations!" />
