    ...
    <div className="h-screen">
      <div className="flex flex-row">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-8">
          ...
          <div className="lg:col-span-2 lg:mt-0 mt-5 flex justify-between">
            ...
            <Image src={"/rizky.jpg"} alt="Profile" width={500} height={500} className="w-60 h-40 lg:w-full rounded-md lg:rounded-e-sm object-cover lg:h-full" />
          </div>
        </div>
      </div>
