...
export default function AboutSection() {
  return (
    <div className="bg-muted/40 dark:bg-muted/20 px-10 py-6 rounded-md" id="about-section">
      ...
      <div className="grid md:grid-cols-10 space-x-5 lg:space-x-5">
        <div className="col-span-2">
          <Image src={"/rizky.jpg"} alt="Profile" width={500} height={500} className="w-60 h-full lg:w-full rounded-md lg:rounded-e-sm object-cover lg:h-full" />
        </div>
